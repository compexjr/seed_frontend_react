...
export default function AuthLayout() {
	return (
		<div className="grid xl:grid-cols-3 h-screen w-full">
			<div className="hidden xl:flex items-center justify-center w-full bg-zinc-950 text-white">
				<h1 className="text-4xl font-semibold flex items-center gap-4">
					<Laptop size={40} /> Seed Front React
				</h1>
			</div>

			<div className="xl:col-span-2 flex flex-col w-full bg-white text-black px-4">
